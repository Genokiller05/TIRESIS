  ...
  private translations = {
    'Español': {
      ...
      alertas: {
        ...
        alertTypeOptions: ['Movimiento detectado', 'Cámara desconectada', 'Intrusión', 'Botón de pánico', 'Fallo de sensor', 'Acceso no autorizado'],
    ...
    'English': {
      ...
      alertas: {
        ...
        alertTypeOptions: ['Movement detected', 'Camera disconnected', 'Intrusion', 'Panic button', 'Sensor failure', 'Unauthorized access'],
